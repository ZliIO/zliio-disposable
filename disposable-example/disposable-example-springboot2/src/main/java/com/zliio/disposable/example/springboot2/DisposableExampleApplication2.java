package com.zliio.disposable.example.springboot2;
...
public class DisposableExampleApplication2 {
    /**
     * Slf4j Logger.
     */
    private static final Logger log = LoggerFactory.getLogger(DisposableExampleApplication2.class);

    public static void main(String[] args) {
        ApplicationContext applicationContext = SpringApplication.run(DisposableExampleApplication2.class, args);
